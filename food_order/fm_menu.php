...
<body>
  <a class="langB" href="fm_menu1.php">TH</a>  
  <a class="langB" >EN</a>   
...
<div id="soup" class="tabcontent">
  ...
  <div class="menu">
    <?php
      $sql = "SELECT * FROM food WHERE active = 'Yes' AND category_id = 2 ";
      ...
      ?>
          ...
          <div class="menu-item">
            ...
            <p><?php echo $price?></p>
            <button class="del" onclick="delFromCart('<?php echo $title; ?>', '<?php echo $price; ?>')">Remove</button>
            <button class="add" onclick="addToCart('<?php echo $title; ?>', '<?php echo $price; ?>')">Add</button>
          </div>
      <?php
        }
      } else {
...
<div id="noodle" class="tabcontent">
  ...
  <div class="menu">
    <?php
      $sql = "SELECT * FROM food WHERE active = 'Yes' AND category_id = 3 ";
      $res = mysqli_query($conn, $sql);
      $count = mysqli_num_rows($res);
      if ($count > 0) {
        while ($row = mysqli_fetch_assoc($res)) {
...
<div id="meat" class="tabcontent">
  ...
  <div class="menu">
    <?php
      $sql = "SELECT * FROM food WHERE active = 'Yes' AND category_id = 4 ";
      $res = mysqli_query($conn, $sql);
      $count = mysqli_num_rows($res);
      if ($count > 0) {
        while ($row = mysqli_fetch_assoc($res)) {
...
<div id="vegetables" class="tabcontent">
  ...
  <div class="menu">
    <?php
      $sql = "SELECT * FROM food WHERE active = 'Yes' AND category_id = 5 ";
      $res = mysqli_query($conn, $sql);
      $count = mysqli_num_rows($res);
      if ($count > 0) {
        while ($row = mysqli_fetch_assoc($res)) {
...
<div id="additional" class="tabcontent">
  ...
  <div class="menu">
    <?php
      $sql = "SELECT * FROM food WHERE active = 'Yes' AND category_id = 6 ";
      $res = mysqli_query($conn, $sql);
      $count = mysqli_num_rows($res);
      if ($count > 0) {
        while ($row = mysqli_fetch_assoc($res)) {
...
<div id="receipt" class="tabcontent">
  ...
  <div class="cart">
    ...
    <!-- ตัวคำนวณ -->
     <h1 style="color:#990000; text-align: center; font-size: 55px;"><img src="../images/cart.png" style="height: 35px;">Your Queue is</h1>
     <?php
        ...
        // Output data of the first (and only) row
            ...
            echo "<h2 style='color:#990000; text-align: center; font-size: 55px;'>". "No Queue." . "</h2>";
        }
...
?>  
    ...
    <form class="" action="" method="post" autocomplete="off">
        ...
        <input type="radio" name="status" value="Paid">Promtpay</input>
        <input type="radio" name="status" value="Paid">Cash</input>
        <br>
        <p>If you have finished paying. Please click on order button.</p>
